...
public class ProductSteps {
    ...
    @Step("Get the product information with name : {0}")
    ...
    @Step("Update Product information with productID:{0},name:{1},type: {2}, price: {3},shipping: {4},upc:{5},description: {6},manufacturer: {7},model: {8},url: {9},image:{10}")
public ValidatableResponse updateProduct(int productId, String name, String type, double price,int shipping, String upc,
